  ...
  return (
    <section ref={sectionRef} className="px-4 sm:px-8 py-10 lg:py-10 sm:py-20 max-w-7xl mx-auto grid lg:grid-cols-2 gap-8">
      ...
      <div className="space-y-6 sm:space-y-8 text-center lg:text-left">
        ...
        <p className="text-lg sm:text-xl lg:text-2xl text-zinc-600 dark:text-zinc-400 max-w-full lg:max-w-none mx-auto lg:mx-0">Developer yang terus belajar. Saya fokus pada pengembangan web modern menggunakan teknologi terbaru.</p>
      ...
      <div ref={imageRef} className="relative mt-8 lg:mt-0">
        ...
        <div className="absolute bottom-0 right-0 bg-zinc-900 dark:bg-zinc-50 text-zinc-50 dark:text-zinc-900 p-4 sm:p-6 rounded-lg">
          <p className="text-xs sm:text-sm opacity-70">TANGGAL HARI INI</p>
